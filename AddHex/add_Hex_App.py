#YT Title: Interactive Step-by-Step App to Practice Adding HEX
#YT Channel:  @SoftwareNuggets
#Programmer:  Scott Johnson  -- email: softwareNugget65@gmail.com

#YT video link:
#GITHUB source code link:
#https://github.com/softwareNuggets/PythonProjects/tree/main/AddHex
...
class HexAdderApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Hexadecimal Adder")
    ...
    def create_widgets(self):
        ...
        tk.Label(self.root, text="Hex Num 1:", font=LABEL_FONT).grid(row=4, column=0, sticky="e", padx=5)
        tk.Label(self.root, text="+ Hex Num 2:", font=LABEL_FONT).grid(row=5, column=0, sticky="e", padx=5)
        ...
        self.step_button = tk.Button(self.root, text="Solve Problem - Step-by-Step",
    ...
    def step(self):
        ...
        self.step_button.config(text=f"Solve Step {step_no}")
    ...
    def build_step_text(self, step_no, idx, a_val, b_val, carry_in, total, carry_out, digit):
        ...
        line2a = f"2. Convert each hex digit into it's decimal number using the Hex Reference chart\n"
        line2a += f"    In column '{col_num}'\n"
        ...
        if total < 16:
            ...
            line4a += f"    Is the decimal total ({total} >= 16)?   NO\n"
    ...
    def clear_all(self):
        ...
        self.reset_backgrounds()
        self.step_button.config(text="Solve Problem - Step-by-Step")
